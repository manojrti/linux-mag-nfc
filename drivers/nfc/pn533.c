...
static void pn533_recv_response(struct urb *urb)
{
	...
	print_hex_dump(KERN_DEBUG, "PN533 RX: ", DUMP_PREFIX_NONE, 16, 1, in_frame,
...
static void pn533_acr122_poweron_rdr_resp(struct urb *urb)
{
	...
	print_hex_dump(KERN_DEBUG, "ACR122 RX: ", DUMP_PREFIX_NONE, 16, 1,
...
static int pn533_acr122_poweron_rdr(struct pn533 *dev)
{
	...
	print_hex_dump(KERN_DEBUG, "ACR122 TX: ", DUMP_PREFIX_NONE, 16, 1,
